  ...
  // ─── Process001 (5개 레이어, 51s) ───
  {
    ...
    props: {
      ...
      scenes: [
        ...
        { type: 'layers', startSec: 8.5, endSec: 21.5 },
        { type: 'text', startSec: 21.5, endSec: 28, text: '도메인별 스킬 플러그인\n재무, 디자인, 마케팅, 프로덕트\n각 도메인의 전문 지식', highlightWord: '스킬 플러그인' },
        { type: 'text', startSec: 28, endSec: 35.5, text: '온톨로지\n기업의 역사, 자료가\n지식화된 문서', highlightWord: '온톨로지' },
        { type: 'text', startSec: 35.5, endSec: 42.5, text: '12개 팩트 기반 온톨로지\n7개 전략 분석 문서', highlightWord: '12개' },
        { type: 'text', startSec: 42.5, endSec: 48, text: '메모리 레이어\n피드백을 기억하고\n학습하는 시스템', highlightWord: '메모리' },
      ],
      subtitles: [
  ...
  // ─── Hook001 (온톨로지 = AI 장기 근속자, 58s) ───
  {
    ...
    props: {
      ...
      scenes: [
        ...
        { type: 'text', startSec: 9, endSec: 16, text: 'Gemini나 GPT 같은 범용 LLM과\n에이전트 팀의 차이', highlightWord: '차이' },
        { type: 'text', startSec: 16, endSec: 22, text: '우리 회사의 맥락을\n알고 있느냐 아니냐', highlightWord: '맥락' },
        { type: 'layers', startSec: 22, endSec: 34 },
        { type: 'text', startSec: 34, endSec: 42, text: '마크다운 기반으로\n비교적 쉽게 구축 가능' },
  ...
  // ─── Hook002 (피드백 루프, 55s) ───
  {
    ...
    props: {
      ...
      scenes: [
        ...
        { type: 'list', startSec: 10, endSec: 18, text: '숫자는 한 번 더 검증해\n이건 동의하지 않아\n별로야, 구려' },
        { type: 'text', startSec: 18, endSec: 24, text: '피드백을\n여러 가지로 저장', highlightWord: '저장' },
        { type: 'text', startSec: 24, endSec: 32, text: '한 번, 두 번, 세 번\n반복될수록 강하게 반영', highlightWord: '강하게' },
        { type: 'text', startSec: 32, endSec: 40, text: '피드백 루프를 구축해야\n에이전트 시스템의 이득', highlightWord: '피드백 루프' },
  ...
  // ─── Hook003 (CEO 스태프 시스템, 63s) ───
  {
    ...
    props: {
      ...
      scenes: [
        ...
        { type: 'text', startSec: 20, endSec: 28, text: '에이전트 팀과\n하네스를 설계한 케이스' },
        { type: 'agenthub', startSec: 28, endSec: 42 },
        { type: 'layers', startSec: 42, endSec: 52 },
        { type: 'text', startSec: 52, endSec: 60, text: 'CEO 스태프가 업무를 받으면\n적합한 에이전트에게 분배' },
      ],
      subtitles: [
  ...
  // ─── Hook004 (콘텐츠 파이프라인, 57s) ───
  {
    ...
    props: {
      ...
      scenes: [
        ...
        { type: 'pipeline', startSec: 11, endSec: 24 },
        { type: 'text', startSec: 24, endSec: 32, text: 'Slack과 Notion의 변경 사항을\n다 모니터링합니다', highlightWord: '모니터링' },
        { type: 'text', startSec: 32, endSec: 40, text: '회사 내부 동향 +\n업계 뉴스, 경쟁사 동향' },
        { type: 'text', startSec: 40, endSec: 48, text: '합의된 채널과\n합의된 지식들만\n모니터링하도록 설계', highlightWord: '보안' },
        { type: 'text', startSec: 48, endSec: 54, text: '소재를 발굴하고\n주제를 뽑아내는\n드래프트 에이전트', highlightWord: '드래프트' },
      ],
      subtitles: [
  ...
  // ─── Process002 (온톨로지 구축, 87s) ───
  {
    ...
    props: {
      ...
      scenes: [
        ...
        { type: 'text', startSec: 10, endSec: 18, text: 'Gemini나 GPT 같은\n범용 LLM도 일은 잘 합니다' },
        { type: 'text', startSec: 18, endSec: 28, text: '에이전트 팀과의 차이?\n회사 맥락을 아느냐 모르느냐', highlightWord: '회사 맥락' },
        { type: 'layers', startSec: 28, endSec: 40 },
        { type: 'text', startSec: 40, endSec: 48, text: '온톨로지 구축이\n예전에는 어려웠는데' },
        { type: 'text', startSec: 48, endSec: 58, text: 'AI를 활용하면\n마크다운 기반으로\n비교적 쉽게 구축', highlightWord: '마크다운' },
  ...
  // ─── Process003 (에이전트 팀 구조, 67s) ───
  {
    ...
    props: {
      ...
      scenes: [
        ...
        { type: 'text', startSec: 36, endSec: 46, text: 'CEO가 업무를 요청하면\nCEO 스태프가 먼저 받고' },
        { type: 'text', startSec: 46, endSec: 56, text: '적합한 에이전트에게\n분배하는 허브 시스템', highlightWord: '허브 시스템' },
  ...
  // ─── Process004 (콘텐츠 마케팅 파이프라인, 105s) ───
  {
    ...
    props: {
      ...
      scenes: [
        ...
        { type: 'pipeline', startSec: 12, endSec: 28 },
        { type: 'text', startSec: 28, endSec: 38, text: 'Slack과 Notion\n외부 동향을 파악' },
        { type: 'text', startSec: 38, endSec: 48, text: '모니터 에이전트가\n소재를 발굴합니다', highlightWord: '모니터 에이전트' },
        { type: 'text', startSec: 48, endSec: 56, text: '컨텐츠 마케터가\n진짜 하는 일을 AI가 대신', highlightWord: 'AI가 대신' },
        { type: 'text', startSec: 56, endSec: 64, text: '합의된 채널만\n모니터링하도록 보안 설계' },
        { type: 'text', startSec: 64, endSec: 72, text: '드래프트 에이전트가\n주제를 뽑고', highlightWord: '드래프트' },
        { type: 'text', startSec: 72, endSec: 82, text: 'SEO, GEO, AEO에\n최적화된 콘텐츠 생성', highlightWord: 'SEO/GEO/AEO' },
        { type: 'text', startSec: 82, endSec: 96, text: '블로그 초안이 나오면\n휴먼아이저 에이전트가\nAI 흔적을 제거', highlightWord: '휴먼아이저' },
        { type: 'text', startSec: 96, endSec: 102, text: '사람이 보는 콘텐츠 +\nAI가 볼 콘텐츠\n분리 가능' },
      ],
      subtitles: [
